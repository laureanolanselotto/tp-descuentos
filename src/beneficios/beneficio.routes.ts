...
BeneficioRouter.put("/:id", controler.sanitizeBeneficioInput,controler.update); // act
BeneficioRouter.patch("/:id", controler.sanitizeBeneficioInput,controler.update); // a
